...
@NonNullApi
public class VYOMProjectDependency extends DelegatingProjectDependency {

    @Inject
    public VYOMProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
